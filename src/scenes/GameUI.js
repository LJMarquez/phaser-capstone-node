...
export default class GameUI extends Phaser.Scene {
  ...
  create(data) {
    ...
    this.knifeCountText = this.add.text(
      30,
      20,
    ...
    this.lawnMowerOutline = this.add.image(370, 230, "lawn-mower-outline");
    this.lawnMowerOutline.setScale(0.2);

    this.drillOutline = this.add.image(320, 230, "drill-outline");
    this.drillOutline.setScale(0.2);

    this.wrenchOutline = this.add.image(270, 230, "wrench-outline");
    ...
    // sceneEvents.on("bod-intro", this.bodIntro, this);
  ...
  collectLawnMower() {
    ...
    this.lawnMower = this.add.image(370, 230, "lawn-mower");
  ...
  collectWrench() {
    ...
    this.wrench = this.add.image(270, 230, "wrench");
